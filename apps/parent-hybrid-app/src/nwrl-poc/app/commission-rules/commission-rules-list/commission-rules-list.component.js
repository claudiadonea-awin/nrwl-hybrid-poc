commissionRulesListController.$inject = [
//   'DwinAdapter',
  '$rootScope',
//   '$loading',
//   'RuleService',
...
function commissionRulesListController (
    // DwinAdapter,
    $rootScope,
    // $loading,
    // RuleService,
    ...
    function refreshList(filters) {
        ...
        // RuleService.getList(vm.page, vm.pageSize, vm.column, vm.sort, null/*vm.servicePartnerId*/, filters).then(
        //     getListItemsSuccess,
        //     getListItemsFailure
        // );
...
module.exports = {
  ...
  controller: () => {},//commissionRulesListController,
  controllerAs: '$ctrl',
  bindings: {
    rules: '='
  }
